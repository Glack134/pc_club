...
const (
	...
	AdminService_RevokeAccess_FullMethodName = "/rpc.AdminService/RevokeAccess"
)
...
type AdminServiceClient interface {
	...
	RevokeAccess(ctx context.Context, in *RevokeRequest, opts ...grpc.CallOption) (*Response, error)
}
...
func (c *adminServiceClient) RevokeAccess(ctx context.Context, in *RevokeRequest, opts ...grpc.CallOption) (*Response, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Response)
	err := c.cc.Invoke(ctx, AdminService_RevokeAccess_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AdminServiceServer interface {
	...
	RevokeAccess(context.Context, *RevokeRequest) (*Response, error)
...
func (UnimplementedAdminServiceServer) RevokeAccess(context.Context, *RevokeRequest) (*Response, error) {
...
func _AdminService_RevokeAccess_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RevokeRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AdminServiceServer).RevokeAccess(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AdminService_RevokeAccess_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AdminServiceServer).RevokeAccess(ctx, req.(*RevokeRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AdminService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _AdminService_RevokeAccess_Handler,
		},
	},
